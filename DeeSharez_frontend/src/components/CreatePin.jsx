...
const CreatePin = ({user}) => {
  ...
  return (
    <div className='flex flex-col justify-center items-center mt-5 lg:h-4/5'>
      {fields && (
        <p className='text-red-500 mb-5 text-xl transition-all'>Please Fill In all the fields</p>
      )}
      <div className='flex lg:flex-row flex-col justify-center items-center bg-white lg:p-5 p-3 lg:w-4/5 w-full'>
          ...
          >
            ...
            {!imageAsset ? (
              ...
              <div className='flex flex-col items-center justify-center h-full'>
                ...
                <p className='mt-32 text-gray-400'>Use high-quality JPG,SVG,PNG,GIF less than 20  MB
                </p>
              </div>
              <input 
                type="file"
        ...
        <div className='flex flex-1 flex-col gap-6 lg:pl-5 mt-4 w-full'>
              <input type="text" 
                ...
                className='outline-none text-lg sm:text-xl font-bold border-b-2 border-gray-200'
              />
              {user && (
